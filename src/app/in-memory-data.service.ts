...
export class InMemoryDataService implements InMemoryDbService {
  ...
  createDb() {
    ...
    const employees = [
      { id: 11, name: 'Nice', email: 'r@g.com', title: 'Dr', middleName: '', lastName: 'Nice', phone: 96325874, dob: Date.now() },
      ...
      { id: 14, name: 'Celeritas', email: 'r@g.com', title: 'Mx', middleName: 'd', lastName: 'x', phone: 96325874, dob: Date.now() },
      ...
      { id: 18, name: 'IQ', email: 'r@g.com', title: 'Dr', middleName: 'd', lastName: 'x', phone: 96325874, dob: Date.now() },
